...
export default function RegisterEmailVerify({
  ...
  const emailDuCheck = async () => {
    ...
    try {
      const email_verify = await fetch(
        'https://www.jerneithe.site/user/signup/email',
        {
          method: 'POST',
          headers: {
  ...
  const emailAuth = async () => {
    ...
    try {
      const send_verifycode = await fetch(
        'https://www.jerneithe.site/user/signup/email/send',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const emailAuth_code = async () => {
    ...
    try {
      const send_email_code = await fetch(
        'https://www.jerneithe.site/user/signup/email/send',
        {
          method: 'POST',
          headers: {
